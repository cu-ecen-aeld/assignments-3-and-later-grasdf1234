...
# georg@Ubuntu:/tmp/aeld/rootfs/bin$ aarch64-none-linux-gnu-readelf -a busybox | grep "program interpreter"
#       [Requesting program interpreter: /lib/ld-linux-aarch64.so.1]
# georg@Ubuntu:/tmp/aeld/rootfs/bin$ aarch64-none-linux-gnu-readelf -a busybox | grep "Shared library"
